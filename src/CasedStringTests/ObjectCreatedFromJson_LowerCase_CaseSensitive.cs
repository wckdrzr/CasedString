...
{
    public class ObjectCreatedFromJson_LowerCase_CaseSensitive
    {
        public CasedString TestObject { get; set; }

        public ObjectCreatedFromJson_LowerCase_CaseSensitive()
        {
            string json = $"{{ \"value\": \"{TestStrings.LowerCaseString}\", \"caseSensitive\": true }}";
            CasedString? deserialisedObject = JsonSerializer.Deserialize<CasedString>(json);
