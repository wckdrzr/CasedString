...
{
    public class ObjectCreatedViaNew_LowerCase_CaseSensitiveLater
    {
        public CasedString TestObject { get; set; }

        public ObjectCreatedViaNew_LowerCase_CaseSensitiveLater()
        {
            TestObject = new(TestStrings.LowerCaseString);
