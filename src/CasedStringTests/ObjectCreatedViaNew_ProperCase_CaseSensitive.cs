...
{
    public class ObjectCreatedViaNew_ProperCase_CaseSensitive
    {
        public CasedString TestObject { get; set; }

        public ObjectCreatedViaNew_ProperCase_CaseSensitive()
        {
            TestObject = new(TestStrings.ProperCaseString, caseSensitive: true);
        }
