...
{
    public class ObjectCreatedFromJson_WithNewtonsoft_LowerCase_CaseSensitive
    {
        public CasedString TestObject { get; set; }

        public ObjectCreatedFromJson_WithNewtonsoft_LowerCase_CaseSensitive()
        {
            string json = $"{{ \"value\": \"{TestStrings.LowerCaseString}\", \"caseSensitive\": true }}";
