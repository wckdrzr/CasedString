...
{
    public class ObjectCreatedViaNew_LowerCase_CaseSensitive
    {
        public CasedString TestObject { get; set; }

        public ObjectCreatedViaNew_LowerCase_CaseSensitive()
        {
            TestObject = new(TestStrings.LowerCaseString, caseSensitive: true);
        }
