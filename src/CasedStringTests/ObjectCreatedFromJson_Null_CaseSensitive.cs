...
{
    public class ObjectCreatedFromJson_Null_CaseSensitive
    {
        public CasedString? TestObject { get; set; }

        public ObjectCreatedFromJson_Null_CaseSensitive()
        {
            string json = $"{{ \"value\": null, \"caseSensitive\": true }}";
            TestObject = JsonSerializer.Deserialize<CasedString>(json);
        }
