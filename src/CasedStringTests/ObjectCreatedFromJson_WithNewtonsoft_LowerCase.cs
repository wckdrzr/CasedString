...
{
    public class ObjectCreatedFromJson_WithNewtonsoft_LowerCase
    {
        public CasedString TestObject { get; set; }

        public ObjectCreatedFromJson_WithNewtonsoft_LowerCase()
        {
            string json = $"\"{TestStrings.LowerCaseString}\"";
